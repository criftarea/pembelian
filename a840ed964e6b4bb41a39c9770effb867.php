...
<tbody>
    ...
    <tr>
        ...
        <td>
            <form onsubmit="return confirm('Yakin hapus data?');" method="POST" action="<?php echo e(route('pembelian.hapus', $d->id_pembelian)); ?>">
                <?php echo csrf_field(); ?>
        ...
        <div class="modal fade" id="tambah" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog" style="width: 600px">
              <div class="modal-content">
                ...
                <form method="POST" action="<?php echo e(route('pembelian.simpan')); ?>">
...
<?php echo $__env->make('layout.menu4', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pembelian\resources\views/pembelian/tampil.blade.php ENDPATH**/ ?>